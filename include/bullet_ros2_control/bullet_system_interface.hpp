...
#ifndef BULLET_ROS2_CONTROL__BULLET_SYSTEM_INTERFACE_HPP_
#define BULLET_ROS2_CONTROL__BULLET_SYSTEM_INTERFACE_HPP_

/// Includes for ros2_control
...
class BulletSystemInterface
  : public hardware_interface::SystemInterface
{
public:
  /// \brief Initilize the system interface
  /// param[in] model_nh pointer to the ros2 node
  /// param[in] b3RobotSimulatorClientAPI_NoGUI shared pointer to Bullet.
...
#endif /* PYBULLET_ROS2_CONTROL__BULLET_SYSTEM_INTERFACE_HPP_ */
